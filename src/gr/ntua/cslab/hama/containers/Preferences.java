...
public class Preferences {
	...
	public Preferences(String[] preferences, boolean orderedByRank){
		if(orderedByRank){
			this.setPreferencesOrderedByRank(Preferences.getPreferenceArray(preferences));
		} else {
			this.setPreferencesOrderedById(Preferences.getPreferenceArray(preferences));
		}
	}
